...
const allEquipment: Equipment[] = [
  ...
  { id: 'A5', name: 'Pre-Lithium Extraction Reactor', zone: 'A', category: 'Leaching', function: 'Early-stage lithium recovery', specs: ['In-situ crystal transformation', '90-98% Li recovery', '>98% Li selectivity', 'No wastewater generated'], vendor: 'Proprietary' },
